...
grep -q '현재 고정된 immediate next task는 `portfolio-review-feedback-action-router-visibility-v1`' AGENTS.md
...
grep -q "benchmark-drift-outlier-decision-v1" docs/project-execution-roadmap.md
...
grep -q "portfolio-review-feedback-action-router-v1" docs/project-execution-roadmap.md
grep -q "portfolio-review-feedback-action-router-visibility-v1" docs/project-execution-roadmap.md
...
test -f docs/tasks/professional-source-gap-remediation-decision-v1/review.md
test -f docs/tasks/professional-source-blocker-raw-filing-remediation-v1/contract.md
...
test -f docs/tasks/benchmark-drift-outlier-decision-v1/contract.md
test -f docs/tasks/benchmark-drift-outlier-decision-v1/handoff.md
test -f docs/tasks/benchmark-drift-outlier-decision-v1/review.md
test -f docs/plans/2026-05-27-benchmark-drift-outlier-decision-v1.md
test -f docs/tasks/portfolio-review-decision-history-v1/contract.md
test -f docs/tasks/portfolio-review-decision-history-v1/handoff.md
test -f docs/tasks/portfolio-review-decision-history-v1/review.md
test -f docs/plans/2026-05-27-portfolio-review-decision-history-v1.md
test -f docs/tasks/portfolio-review-decision-outcome-feedback-v1/contract.md
test -f docs/tasks/portfolio-review-decision-outcome-feedback-v1/handoff.md
test -f docs/tasks/portfolio-review-decision-outcome-feedback-v1/review.md
test -f docs/plans/2026-05-27-portfolio-review-decision-outcome-feedback-v1.md
test -f docs/tasks/portfolio-review-feedback-calibration-v1/contract.md
...
test -f docs/tasks/portfolio-review-feedback-action-router-v1/contract.md
test -f docs/tasks/portfolio-review-feedback-action-router-v1/handoff.md
test -f docs/tasks/portfolio-review-feedback-action-router-v1/review.md
test -f docs/plans/2026-05-27-portfolio-review-feedback-action-router-v1.md
test -f docs/tasks/portfolio-review-feedback-action-router-visibility-v1/contract.md
test -f docs/tasks/portfolio-review-feedback-action-router-visibility-v1/handoff.md
test -f docs/tasks/portfolio-review-feedback-action-router-visibility-v1/review.md
test -f docs/plans/2026-05-27-portfolio-review-feedback-action-router-visibility-v1.md
test -f docs/plans/2026-05-27-professional-source-gap-prioritization-v1.md
test -f docs/tasks/professional-source-gap-remediation-decision-v1/contract.md
test -f docs/tasks/professional-source-gap-remediation-decision-v1/handoff.md
test -f docs/tasks/professional-source-gap-remediation-decision-v1/review.md
test -f docs/plans/2026-05-27-professional-source-gap-remediation-decision-v1.md
...
test -f docs/tasks/recommendation-outcome-due-cadence-automation-v1/contract.md
