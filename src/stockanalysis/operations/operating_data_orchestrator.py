...
DECISION_DAILY_STEP_IDS = (
    # Historical outcomes depend on stored prices, not today's AI or universe.
...
OPERATING_DATA_RUN_PROFILES: tuple[OperatingDataRunProfile, ...] = (
    OperatingDataRunProfile(
        ...
        step_ids=("research-maintenance", "equity-research-reporting"),
    ),
    OperatingDataRunProfile(
    ...
    steps.extend(
        [
            ...
            ),
            {
                ...
                "label": "Refresh one Korean research report when its financial source changes",
                "skip_reason": "",
                "command_argv": (
                    python_executable,
                    "-m",
                    "stockanalysis.operations.cli",
                    "research-report-refresh-run",
                    "--env-file",
                    str(env_file),
                    "--execute",
                ),
