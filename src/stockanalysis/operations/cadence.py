...
DATA_OPERATION_CADENCES: tuple[DataOperationCadence, ...] = (
    ...
    DataOperationCadence(
        job_id="cross-asset-indicator-ingest-daily",
        pipeline_name="cross_asset_indicator_ingest",
        domain="market",
        cadence="daily",
        command_template="stockanalysis-operations cross-asset-indicator-ingest-run --env-file <ENV> --as-of-date <YYYY-MM-DD> --execute",
        expected_after_local="18:40",
        stale_after_hours=36,
        artifact_policy="stdout_json_stderr_log_and_indicator_counts",
        required_env_groups=("database", "fred", "market_price_provider"),
        data_health_dataset="market.market_indicator_observation",
    ),
    DataOperationCadence(
        job_id="cross-asset-provider-fetch-daily",
        pipeline_name="cross_asset_indicator_provider_fetch",
        domain="market",
        cadence="daily",
        command_template="stockanalysis-operations cross-asset-indicator-provider-fetch-run --env-file <ENV> --as-of-date <YYYY-MM-DD> --execute",
        expected_after_local="18:42",
        stale_after_hours=36,
        artifact_policy="stdout_json_stderr_log_and_provider_fetch_counts",
        required_env_groups=("database", "market_price_provider"),
        data_health_dataset="market.market_indicator_observation",
    ),
    DataOperationCadence(
        job_id="cross-asset-market-price-refresh-daily",
        pipeline_name="market_price_upsert",
        domain="market",
        cadence="daily",
        command_template="stockanalysis-operations market-price-free-backfill-run --watchlist <RUNTIME>/cross-asset-price-watchlist.csv --env-file <ENV> --provider twelve_data --skip-if-fresh",
        expected_after_local="18:44",
        stale_after_hours=36,
        artifact_policy="stdout_json_stderr_log_and_cross_asset_watchlist_counts",
        required_env_groups=("database", "market_price_provider"),
        data_health_dataset="market.daily_price_bar",
    ),
    DataOperationCadence(
        job_id="toss-reference-kr-daily",
        pipeline_name="tossinvest_market_data_sync",
        domain="market",
        cadence="daily",
        command_template="stockanalysis-operations tossinvest-market-data-sync-run --market-code KR --sync-mode reference --execute",
        expected_after_local="08:30 Asia/Seoul",
        stale_after_hours=36,
        artifact_policy="stdout_json_stderr_log_and_toss_reference_counts",
        required_env_groups=("database", "tossinvest"),
        data_health_dataset="market.tossinvest_stock_warning_snapshot",
    ),
    DataOperationCadence(
        job_id="toss-reference-us-daily",
        pipeline_name="tossinvest_market_data_sync",
        domain="market",
        cadence="daily",
        command_template="stockanalysis-operations tossinvest-market-data-sync-run --market-code US --sync-mode reference --execute",
        expected_after_local="08:45",
        stale_after_hours=36,
        artifact_policy="stdout_json_stderr_log_and_toss_reference_counts",
        required_env_groups=("database", "tossinvest"),
        data_health_dataset="market.tossinvest_stock_warning_snapshot",
    ...
    DataOperationCadence(
        job_id="toss-candles-kr-daily",
        pipeline_name="tossinvest_market_data_sync",
        domain="market",
        cadence="daily",
        command_template="stockanalysis-operations tossinvest-market-data-sync-run --market-code KR --sync-mode daily_candles --execute",
        expected_after_local="16:10 Asia/Seoul",
        stale_after_hours=36,
        artifact_policy="stdout_json_stderr_log_and_toss_candle_counts",
        required_env_groups=("database", "tossinvest"),
        data_health_dataset="market.tossinvest_daily_candle_snapshot",
    ),
    DataOperationCadence(
        job_id="toss-candles-us-shadow-daily",
        pipeline_name="tossinvest_market_data_sync",
        domain="market",
        cadence="daily",
        command_template=(
    ...
    DataOperationCadence(
        job_id="toss-provider-comparison-daily",
        ...
        required_env_groups=("database", "tossinvest"),
        data_health_dataset="market.tossinvest_provider_comparison_snapshot",
    ),
    DataOperationCadence(
        job_id="toss-priority-microdata-intraday",
        pipeline_name="tossinvest_market_data_sync",
        domain="market",
        cadence="intraday",
        command_template=(
        ...
        required_env_groups=("database", "tossinvest"),
        data_health_dataset="market.tossinvest_market_microdata_snapshot",
    ),
    DataOperationCadence(
        job_id="toss-live-account-readonly",
        pipeline_name="tossinvest_readonly_sync",
        domain="portfolio",
        cadence="intraday",
        command_template="stockanalysis-operations tossinvest-readonly-sync-run --execute",
        expected_after_local="08:55, 12:55, 16:55",
        stale_after_hours=8,
        artifact_policy="stdout_json_stderr_log_and_toss_account_readonly_counts",
        required_env_groups=("database", "tossinvest"),
        data_health_dataset="portfolio.position_snapshot",
    ),
    DataOperationCadence(
        job_id="cross-asset-regime-daily",
        pipeline_name="cross_asset_regime_snapshot",
        domain="signal",
        cadence="daily",
        command_template="stockanalysis-operations cross-asset-regime-snapshot-run --env-file <ENV> --as-of-date <YYYY-MM-DD> --execute",
        expected_after_local="18:50",
        stale_after_hours=36,
        artifact_policy="stdout_json_stderr_log_and_regime_counts",
        required_env_groups=("database",),
        data_health_dataset="signal.cross_asset_regime_snapshot",
    ),
    DataOperationCadence(
        job_id="indicator-news-linkage-daily",
        pipeline_name="indicator_news_linkage",
        domain="news",
        cadence="daily",
        command_template="stockanalysis-operations indicator-news-linkage-run --env-file <ENV> --as-of-date <YYYY-MM-DD> --execute",
        expected_after_local="18:55",
        stale_after_hours=36,
        artifact_policy="stdout_json_stderr_log_and_link_counts",
        required_env_groups=("database",),
    ...
    DataOperationCadence(
        ...
        domain="signal",
        cadence="daily",
        command_template="stockanalysis-operations recommendation-cross-asset-components-run --env-file <ENV> --as-of-date <YYYY-MM-DD> --execute",
        expected_after_local="19:05",
        stale_after_hours=36,
        artifact_policy="stdout_json_stderr_log_and_zero_weight_component_counts",
        required_env_groups=("database",),
    ...
    DataOperationCadence(
        ...
        command_template=(
            ...
            "--env-file <ENV> --cik <CIK> --as-of-date <YYYY-MM-DD> --max-filings 200 --execute"
        ),
        expected_after_local="08:22 Monday",
        stale_after_hours=216,
    ...
    DataOperationCadence(
        job_id="reported-segment-footnote-parser-weekly",
        pipeline_name="reported_segment_footnote_parser",
        domain="fundamentals",
        cadence="weekly",
        command_template="stockanalysis-operations reported-segment-footnote-parser-run --env-file <ENV> --as-of-date <YYYY-MM-DD> --execute",
        expected_after_local="08:46 Monday",
        stale_after_hours=216,
        artifact_policy="stdout_json_stderr_log_and_reported_segment_counts",
        required_env_groups=("database",),
    ...
    DataOperationCadence(
        ...
        domain="fundamentals",
        cadence="weekly",
        command_template="stockanalysis-operations sum-of-parts-valuation-run --env-file <ENV> --as-of-date <YYYY-MM-DD> --execute",
        expected_after_local="08:48 Monday",
        stale_after_hours=216,
        artifact_policy="stdout_json_stderr_log_and_sotp_component_counts",
        required_env_groups=("database",),
        data_health_dataset="market.sum_of_parts_component",
    ),
    DataOperationCadence(
    ...
    DataOperationCadence(
        ...
        domain="performance",
        cadence="daily",
        command_template="stockanalysis-operations recommendation-outcome-backfill-run --env-file <ENV> --due-on-date <YYYY-MM-DD> --limit 20 --execute",
    ...
    DataOperationCadence(
        ...
        domain="performance",
        cadence="daily",
        command_template="stockanalysis-operations recommendation-outcome-due-action-router-run --env-file <ENV> --as-of-date <YYYY-MM-DD> --limit 20 --execute",
    ...
    DataOperationCadence(
        job_id="portfolio-review-feedback-action-router-daily",
        pipeline_name="portfolio_review_feedback_action_router",
        domain="portfolio",
        cadence="daily",
        command_template='stockanalysis-operations portfolio-review-feedback-action-router-run --env-file <ENV> --portfolio-name "Long Term Paper" --as-of-date <YYYY-MM-DD> --execute',
        expected_after_local="19:50",
        stale_after_hours=36,
        artifact_policy="stdout_json_stderr_log_and_action_router_audit",
        required_env_groups=("database",),
        data_health_dataset="ai.eval_run",
