...
class ProfessionalEquityAnalysisTests(unittest.TestCase):
    ...
    def test_sum_of_parts_valuation_upsert_sql_creates_components_without_recommendation_mutation(self) -> None:
        ...
        self.assertIn("research.segment_footnote_evidence", sql)
        self.assertIn("reported_segment_input_rows", sql)
        self.assertIn("reported_segment_inputs", sql)
        self.assertIn("reported_segment_allocation_rows", sql)
        self.assertIn("reported_segment_allocations", sql)
        self.assertIn("reported_segment_history_rows", sql)
        self.assertIn("reported_segment_trends", sql)
        self.assertIn("reported_segment_assumption_rows", sql)
        self.assertIn("reported_segment_assumptions", sql)
        self.assertIn("deterministic_margin_share_proxy_no_score_change", sql)
        self.assertIn("multi_period_segment_trend_template", sql)
        self.assertIn("driver_template_key", sql)
        self.assertIn("observed_revenue_cagr", sql)
        self.assertIn("observed_margin_change", sql)
        self.assertIn("base_growth_rate", sql)
        self.assertIn("base_multiple", sql)
        self.assertIn("allocated_fair_value_base", sql)
        self.assertIn("operating_income_share_then_revenue_share", sql)
        self.assertIn("segment_operating_income", sql)
        self.assertIn("operating_margin", sql)
        self.assertNotIn("signal.recommendation_score_component", sql)
    ...
    def test_valuation_snapshot_upsert_sql_creates_methods_without_recommendation_mutation(self) -> None:
        ...
        self.assertIn("'reported_segment_input_count'", sql)
        self.assertIn("'reported_segment_inputs'", sql)
        self.assertIn("'reported_segment_allocation_count'", sql)
        self.assertIn("'reported_segment_allocations'", sql)
        self.assertIn("'reported_segment_assumption_count'", sql)
        self.assertIn("'reported_segment_assumptions'", sql)
        ...
        self.assertIn("사업부별 성장률·마진·밸류에이션 배수", sql)
