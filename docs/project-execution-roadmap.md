...
1. `reported-segment-unit-normalization-v1`: normalize reported segment metric units from filing context before segment-specific valuation assumptions are added.
...
40. `reported-segment-unit-normalization-v1`: next task; normalize `USD_as_reported` values from filing context before segment-specific growth/multiple assumptions are added.
