...
1. `segment-specific-sotp-assumptions-v1`: add segment-specific growth, margin, multiple, and driver assumptions using normalized reported segment units, without changing recommendation weights.
...
41. `segment-specific-sotp-assumptions-v1`: next task; add segment-level growth, margin, multiple, and driver assumptions using normalized segment units without changing recommendation weights.
