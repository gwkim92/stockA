...
1. `segment-level-sotp-inputs-v1`: use reported segment revenue and operating income evidence as explicit SOTP input/visibility without changing recommendation weights.
