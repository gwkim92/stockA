...
1. `segment-sotp-driver-calibration-v1`: calibrate segment assumptions with multi-period segment trend and industry-specific driver templates before any score weight use.
...
42. `segment-sotp-driver-calibration-v1`: next task; calibrate segment assumptions with multi-period segment trend and industry-specific driver templates before any score weight use.
