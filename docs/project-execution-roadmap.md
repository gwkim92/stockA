...
48. `segment-history-source-linkage-remediation-v1`: next task; inspect ARM/EROK companyfacts/source-document blockers and remediate or precisely classify them without changing recommendation weights or order boundaries.
