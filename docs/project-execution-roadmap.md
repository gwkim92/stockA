...
1. `financial-forecast-and-scenario-inputs-v1`: build explicit revenue, margin, CAPEX, and FCF forecast inputs behind DCF/scenario valuation before any recommendation weight changes.
...
32. `financial-forecast-and-scenario-inputs-v1`: next task; convert static DCF-lite/scenario assumptions into explicit forecast inputs for revenue, margin, CAPEX, and FCF without changing recommendation weights.
