...
1. `segment-footnote-extraction-foundation-v1`: extract SEC segment/footnote evidence so SOTP can move beyond proxy components.
...
34. `segment-footnote-extraction-foundation-v1`: next task; extract SEC segment/footnote evidence so future SOTP can use actual business segment data instead of proxy components.
