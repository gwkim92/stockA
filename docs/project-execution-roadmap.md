...
64. `source-blocked-recommendation-guardrail-v1`: planned as the next task; source-blocked operating-company recommendations such as EROK must be blocked for professional decision use without deleting history or changing score weights.
