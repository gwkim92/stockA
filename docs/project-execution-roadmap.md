...
1. `reported-segment-parser-quality-v1`: expand real SEC/iXBRL segment parsing so linked raw 10-K candidates produce reported segment metrics for SOTP evidence.
...
37. `reported-segment-parser-quality-v1`: next task; expand real SEC/iXBRL segment parsing so linked raw 10-K candidates produce reported segment metrics for SOTP evidence.
