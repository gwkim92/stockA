...
71. `portfolio-review-feedback-action-router-visibility-v1`: planned next; expose the latest router decision as first-class data-health and portfolio coverage API/UI state.
