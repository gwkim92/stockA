...
base=pathlib.Path('/opt/stockanalysis/runtime/research-data-quality-20260911')
...
def main():
    ...
    try:
        ...
        statuses={}
        for port,path,phrase in [(3000,'/stocks/NVDA','원천 검토'),(3000,'/stocks/AAPL','원천 검토'),(3000,'/stocks/ARM','원천 검토'),(3000,'/recommendations/recommendation-1501','원천 검토'),(3000,'/performance/recommendations','전체 추천 성과'),(13000,'/admin/ai-agents','AI 모델 설정')]:
