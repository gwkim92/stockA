...
- Added a secret-free live scheduler activation request packet.
- Approved gate evidence now produces `pending_explicit_user_approval`, not host activation.
...
- Actual scheduler activation remains blocked until a future explicit user decision task.
