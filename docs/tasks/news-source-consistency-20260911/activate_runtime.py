...
base=pathlib.Path('/opt/stockanalysis/runtime/news-source-consistency-20260911')
...
def main():
    ...
    try:
        ...
        statuses={}
        for port,path,phrase in [(3000,'/source-documents/source-document-22','원천 대조'),(3000,'/recommendations','투자 후보'),(3000,'/performance','판단 성과'),(13000,'/admin/ai-agents','AI 모델 설정')]:
