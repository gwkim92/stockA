...
- exact next step: commit and push the local UX copy changes, deploy the branch on EC2, restart `stockanalysis-web.service`, then smoke `/paper-trading` and `/trading-readiness` through `http://127.0.0.1:13000`.
