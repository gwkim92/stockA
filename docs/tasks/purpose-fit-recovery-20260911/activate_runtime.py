...
base=pathlib.Path('/opt/stockanalysis/runtime/purpose-fit-recovery-20260911')
...
def main():
    ...
    try:
        ...
        statuses={}
        for port,path,phrase in [(3000,'/stocks/NVDA','대체 보고서'),(3000,'/recommendations','투자 후보'),(3000,'/performance','판단 성과'),(13000,'/admin/ai-agents','AI 모델 설정')]:
