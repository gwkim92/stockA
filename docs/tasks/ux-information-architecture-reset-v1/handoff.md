...
- passed locally for AI evidence detail flow-card refactor: `cd apps/web && npm run typecheck`
- passed locally for AI evidence detail flow-card refactor: `cd apps/web && npm run build`
- passed locally for AI evidence detail flow-card refactor: `bash scripts/verify_frontend_detail_routes.sh`
- passed locally for AI evidence detail flow-card refactor: `PYTHONPATH=/Users/woody/ai/agent-work-harness/src /opt/homebrew/bin/python3.13 -m awh verify --repo . --task ux-information-architecture-reset-v1`
- passed locally for AI evidence detail flow-card refactor: `git diff --check`
- passed locally for AI evidence detail flow-card refactor: Playwright dev route smoke on `http://127.0.0.1:13002/ai-evidence/sec-event-aapl-10k-20240928`, desktop `aiValidationCards=2`, `relationshipChips=0`, `relationshipPanels=0`, `rawValidatorHits=0`, `rawTraceHits=0`; mobile `aiValidationCards=2`, `relationshipChips=0`, `rawValidatorHits=0`, `rawTraceHits=0`, `overflow=[]`.
...
- passed locally for thesis evidence ledger refactor: `cd apps/web && npm run typecheck`
- passed locally for thesis evidence ledger refactor: `cd apps/web && npm run build`
- passed locally for thesis evidence ledger refactor: `bash scripts/verify_frontend_detail_routes.sh`
- passed locally for thesis evidence ledger refactor: `PYTHONPATH=/Users/woody/ai/agent-work-harness/src /opt/homebrew/bin/python3.13 -m awh verify --repo . --task ux-information-architecture-reset-v1`
- passed locally for thesis evidence ledger refactor: `git diff --check`
- passed locally for thesis evidence ledger refactor: Playwright dev route smoke on `http://127.0.0.1:13002/theses/AAPL-bootstrap-v1`, desktop `thesisEvidencePanels=1`, `thesisEvidenceSummaryCards=4`, `thesisEvidenceCards=2`, `bentoCardsInsideEvidence=0`, `repeatedConnectionDetails=0`, `totalEvidenceAuditDetails=1`, `rawTermHits=[]`, `overflow=[]`; mobile `thesisEvidencePanels=1`, `thesisEvidenceSummaryCards=4`, `thesisEvidenceCards=2`, `bentoCardsInsideEvidence=0`, `repeatedConnectionDetails=0`, `rawTermHits=[]`, `overflow=[]`.
...
- passed locally for performance lower-fold outcome/readability refactor: `cd apps/web && npm run typecheck`
- passed locally for performance lower-fold outcome/readability refactor: `cd apps/web && npm run build`
- passed locally for performance lower-fold outcome/readability refactor: Playwright CLI desktop rendered check on `http://127.0.0.1:13002/performance`; `.performance-panel` count `5`, `.performance-gate-card` count `3`, table count `0`, no Server Component error, no desktop horizontal overflow.
- passed locally for performance lower-fold outcome/readability refactor: Playwright CLI mobile check at `390x900`; `.performance-panel` count `5`, no Server Component error, no horizontal overflow.
...
- passed locally for recommendation detail lower-fold evidence-card refactor: `cd apps/web && npm run typecheck`
- passed locally for recommendation detail lower-fold evidence-card refactor: `cd apps/web && npm run build`
- passed locally for recommendation detail lower-fold evidence-card refactor: Playwright CLI desktop rendered check on `http://127.0.0.1:13002/recommendations/AAPL-2024-11-01`; `.recommendation-evidence-panel` count `1`, `.recommendation-score-card` count `3`, `.recommendation-outcome-panel` count `1`, table count `0`, no Server Component error, no desktop horizontal overflow.
- passed locally for recommendation detail lower-fold evidence-card refactor: Playwright CLI mobile check at `390x900`; `.recommendation-evidence-panel` count `1`, `.recommendation-score-card` count `3`, `.recommendation-outcome-panel` count `1`, no Server Component error, no horizontal overflow.
- passed locally for recommendation detail lower-fold evidence-card refactor: Playwright CLI stock-detail spot check on `http://127.0.0.1:13002/stocks/AAPL`; table count `0`, fact-list count `0`, no Server Component error, no desktop horizontal overflow.
