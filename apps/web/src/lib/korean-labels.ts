const KOREAN_LABELS: Record<string, string> = {
  ...
  "DOMAIN TO SECTOR": "도메인에서 섹터",
  DOMAIN_TO_SECTOR: "도메인에서 섹터",
  domain_to_sector: "도메인에서 섹터",
  "MACRO TO SECTOR": "거시에서 섹터",
  MACRO_TO_SECTOR: "거시에서 섹터",
  macro_to_sector: "거시에서 섹터",
  "MACRO TO DOMAIN": "거시에서 도메인",
  MACRO_TO_DOMAIN: "거시에서 도메인",
  "MACRO TO THEME": "거시에서 테마",
  MACRO_TO_THEME: "거시에서 테마",
  "SECTOR TO THEME": "섹터에서 테마",
  SECTOR_TO_THEME: "섹터에서 테마",
  sector_to_theme: "섹터에서 테마",
  "DOMAIN TO THEME": "도메인에서 테마",
  ...
  live_llm_invocation_attention: "AI 실제 호출 확인 필요",
  accumulate: "분할 매수",
...
const EMBEDDED_LABEL_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/\bTECH_DOMAIN\b/g, "기술 도메인"],
  [/\bTECHNOLOGY\b/g, "기술 섹터"],
  [/\bENERGY_DOMAIN\b/g, "에너지 도메인"],
  [/\bDOMAIN_TO_SECTOR\b/g, "도메인에서 섹터"],
  [/\bDOMAIN TO SECTOR\b/g, "도메인에서 섹터"],
  [/\bMACRO_TO_SECTOR\b/g, "거시에서 섹터"],
  [/\bMACRO TO SECTOR\b/g, "거시에서 섹터"],
  [/\bMACRO_TO_DOMAIN\b/g, "거시에서 도메인"],
  [/\bMACRO TO DOMAIN\b/g, "거시에서 도메인"],
  [/\bMACRO_TO_THEME\b/g, "거시에서 테마"],
  [/\bMACRO TO THEME\b/g, "거시에서 테마"],
  [/\bSECTOR_TO_THEME\b/g, "섹터에서 테마"],
  [/\bSECTOR TO THEME\b/g, "섹터에서 테마"],
  [/\bDOMAIN_TO_THEME\b/g, "도메인에서 테마"],
  [/\bDOMAIN TO THEME\b/g, "도메인에서 테마"],
