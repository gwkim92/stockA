const KOREAN_LABELS: Record<string, string> = {
  ...
  "news-ai-eval-fixture-v1": "뉴스 AI 기준 세트 v1",
  "news-ai-eval-intraday": "뉴스 AI 회귀평가",
  news_ai_eval_quality_attention: "뉴스 AI 회귀평가 확인 필요",
  ...
  ai_review_required: "AI 검증 필요",
  ai_review_passed: "AI 검증 통과",
  ai_review_pending: "AI 검증 대기",
  deterministic_ai_review_required: "AI 검증 필요",
  source_document_ai_review_required: "원천 문서 AI 검증 필요",
  ...
  "news ai evidence intraday": "뉴스·AI 근거 분석",
  "news ai extraction quality": "뉴스 AI 추출 품질",
  ...
  news_event_candidate_rejected: "차단된 뉴스 AI 구조화 항목",
  news_event_candidate_suppressed: "저신호 뉴스 AI 구조화 항목",
