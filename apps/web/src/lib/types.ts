...
export type DataHealthData = {
  ...
  professional_recommendation_coverage_audit: ProfessionalRecommendationCoverageAudit;
...
export type ProfessionalRecommendationCoverageAudit = {
  status: string;
  title: string;
  summary: string;
  as_of_date: string;
