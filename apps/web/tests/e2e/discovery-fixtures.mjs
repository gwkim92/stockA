...
export function discoveryFixture(path, scenario) {
  ...
  if (path === "/api/stocks") {
    ...
    envelope.data.groups = [
      { group_code: "dollar", group_name: "달러", indicators: [{ ...dollar, indicator_code: "DXY", display_name: "달러 지수", latest_observation_date: asOf, latest_value: 102.3, return_1d: 0.002, return_5d: 0.01, return_20d: -0.014, return_60d: null, freshness_status: "fresh" }] },
      { group_code: "rates", group_name: "금리", indicators: [{ ...structuredClone(dollar), indicator_code: "US_10Y", display_name: "미국 10년 금리", latest_observation_date: asOf, latest_value: 4.1, return_1d: null, return_5d: null, return_20d: null, return_60d: null, freshness_status: "fresh" }] },
      { group_code: "metals", group_name: "금속", indicators: [{ ...structuredClone(dollar), indicator_code: "XAG_USD", display_name: "은 프록시 지수", preferred_provider: "fred", latest_observation_date: "2001-01-01", latest_value: 150, return_1d: null, return_5d: null, return_20d: 0.03, freshness_status: "stale" }, { ...structuredClone(dollar), indicator_code: "GOLD", display_name: "금 지표", latest_observation_date: null, latest_value: null, return_1d: null, return_20d: null, freshness_status: "unknown" }] },
    ];
