...
export default defineConfig({
 testDir:'./tests/e2e',testMatch:['review-notebook.home.ts','review-inbox.home.ts','review-continuity.home.ts','review-continuity-safety.home.ts','research-producer.home.ts'],workers:1,fullyParallel:false,
